...
#선 생성(바탕화면, 시작점, 끝점, 색상, 선두깨, 선스타일)
cv2.line(img, (100, 100), (1200, 100), (0, 0, 255), 30, cv2.LINE_AA)
#원 생성(바탕화면, 중심점, 지름, 색상, 선두깨 or 채우는지 여부, 선스타일)
cv2.circle(img, (300, 300), 50, (0, 255, 0), cv2.FILLED, cv2.LINE_4)
#직사각형 생성(바탕화면, 시작점, 끝점, 색상, 선두깨 or 채우는지 여부, 선스타일)
cv2.rectangle(img, (500, 200), (1000, 400), (255, 0, 0), 5, cv2.LINE_8)
#폴리라인 생성(바탕화면, 시작점, 끝점, 색상, 선두깨 or 채우는지 여부, 선스타일)
